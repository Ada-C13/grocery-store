...
describe "Order Wave 1" do
  ...
  describe "#remove product" do
    ...
    it "removed the product from the collection of products" do
      products = { "banana" => 1.99, "cracker" => 3.00 }
      order = Order.new(1337, products, customer)
...
describe "Order Wave 2" do
  ...
  describe "order.find_by_customer(customer_id)" do
    ...
    it "finds all orders for a customer given their customer id" do
      orders = Order.find_by_customer(24)
      orders_ids = [7, 24, 83]
      orders_products = [
